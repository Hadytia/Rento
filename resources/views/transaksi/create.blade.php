    ...
    <div class="form-card">
        ...
        <div class="card-header">
            <div class="card-header-content">
                ...
                <div>
                    <h2>Form Transaksi Rental</h2>
                    <p>Lengkapi semua data penyewaan. Kolom bertanda * wajib diisi.</p>
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <div class="fg-wrap">
                    ...
                    <select name="delivery_method" id="delivery_method" class="form-control" form="formCreate">
                        <option value="">— Pilih Metode —</option>
                        <option value="Pickup"   {{ old('delivery_method') == 'Pickup'   ? 'selected' : '' }}>Pickup — Ambil Sendiri</option>
                        <option value="Delivery" {{ old('delivery_method') == 'Delivery' ? 'selected' : '' }}>Delivery — Diantar Kurir</option>
                        <option value="COD"      {{ old('delivery_method') == 'COD'      ? 'selected' : '' }}>COD — Cash on Delivery</option>
                    </select>
                </div>
                ...
                <div class="form-group full">
                    ...
                    <div class="fg-wrap">
                        ...
                        <textarea name="notes" id="notes" class="form-control"
                            placeholder="Catatan tambahan (opsional)..." form="formCreate">{{ old('notes') }}</textarea>
                    </div>
