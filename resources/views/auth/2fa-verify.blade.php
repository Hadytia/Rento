...
<head>
    ...
    <title>Verifikasi Google Authenticator – Rento</title>
...
<body>
    <div class="card">
        ...
        <div class="icon">🔐</div>
        <h1>Verifikasi Google Authenticator</h1>
        <p>Buka aplikasi Google Authenticator di HP kamu dan masukkan 6 digit kode yang tampil.</p>
